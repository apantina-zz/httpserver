 ...
 * <code>temporaryParameters</code> map, and pushes it onto the stack. If no
 * value is available for the given <code>name</code>, the default value 
 * is pushed.
 * @author 0036502252
 *
 */
public class TemporaryParameterGetFunction implements TokenFunction {
	...
	public void apply(RequestContext context, Stack<Object> stack) {
		...
		Object value = context.getTemporaryParameter(name.replace("\"", ""));
